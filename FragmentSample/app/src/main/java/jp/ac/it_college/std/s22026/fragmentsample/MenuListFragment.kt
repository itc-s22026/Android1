...
import jp.ac.it_college.std.s22026.fragmentsample.databinding.FragmentMenuListBinding

/** Fragment Result API と通じて Activity へデータを返すためのイベント名 */
internal const val REQUEST_SELECTED_MENU = "selectedMenu"

/** Fragment Result API と通じて Activity へメニュー名を返すための識別子 */
internal const val RESULT_NAME = "menuName"

/** Fragment Result API と通じて Activity へ価格を返すための識別子 */
