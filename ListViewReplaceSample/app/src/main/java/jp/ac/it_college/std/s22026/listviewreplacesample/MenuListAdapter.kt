package jp.ac.it_college.std.s22026.listviewreplacesample

import android.view.LayoutInflater
import android.view.ViewGroup
import android.widget.Toast
import androidx.recyclerview.widget.RecyclerView
import jp.ac.it_college.std.s22026.listviewreplacesample.databinding.MenuRowBinding
...
class MenuListAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        // inflate した Binging クラスのインスタンスを使って MenuListAdapter.ViewHolder を作って返す。
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.binding.root.setOnClickListener {
            // 直接 Resoure のインスタンスは取れないので、パラメータのView[it]を経由して
            // 間接的に参照する。
